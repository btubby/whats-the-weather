      ...
      {/* <div className="app-header-container">
        ...
        <div>
          <section>
            ...
            <p>
              Using the OpenWeatherMap API fetch the current weather for a given
              location and refresh every minute.
            </p>
          </section>
          <hr />
          <section>
            ...
            <p>
              Store and display a <em>list</em> of the 5 most recently fetched
              locations and make them easily accessible to the user.
            </p>
          </section>
          <hr />
          <section>
